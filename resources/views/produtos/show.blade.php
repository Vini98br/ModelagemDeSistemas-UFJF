            ...
            <div class="col-md-3">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <strong><i class="fas fa-book mr-1"></i> Quantidade em Estoque</strong>
                        <p class="text-muted">
                            {{ $produto->qntdEmEstoque }}
                        </p>
                        ...
                        <strong><i class="fas fa-dollar-sign mr-1"></i>Preço</strong>
                        <p class="text-muted">
                           R${{ $produto->preco }}
                        </p>

                        <strong><i class="fas fa-dollar-sign mr-1"></i>Preço Promocional</strong>
                        <p class="text-muted">
